...
public class TestRectangle3D {
    ...
    public void testRectangle3D1() {
        ...
        Rectangle3D rect3D = new Rectangle3D(topLeft, bottomRight, 10);
        assertAll(
    ...
    public void testRectangle3D3() {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 10);
        assertAll(
    ...
    public void testEqualsRectangle3D() {
        ...
        Rectangle3D rect3D2 = new Rectangle3D(10, 20, 30, 40, 10);
        Rectangle3D rect3D3 = new Rectangle3D(10, 20, 30, 40, 20);
        Rectangle3D rect3D4 = new Rectangle3D(20, 30, 40, 50, 10);
    ...
    public void testAreaRectangle3D() {
        Rectangle3D rect3D1 = new Rectangle3D(10, 20, 30, 40, 10);
        Rectangle3D rect3D2 = new Rectangle3D(20, 30, 40, 80, 10);
