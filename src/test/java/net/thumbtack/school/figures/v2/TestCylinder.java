...
public class TestCylinder {
    ...
    public void testCylinder1() {
        ...
        Cylinder cylinder = new Cylinder(center, 10, 10, 1);
        assertAll(
                ...
                () -> assertEquals(1, cylinder.getColor())
        );
    }

    @Test
    public void testCylinder2() {
        Cylinder cylinder = new Cylinder(10, 20, 10, 10, 1);
        assertAll(
                () -> assertEquals(10, cylinder.getCenter().getX()),
                () -> assertEquals(20, cylinder.getCenter().getY()),
                () -> assertEquals(10, cylinder.getRadius()),
    ...
    @Test
    public void testChangeColorCylinder() {
        Cylinder cylinder = new Cylinder(10, 20, 10, 10, 1);
        cylinder.setColor(2);
        assertEquals(2, cylinder.getColor());
    }
    ...
    public void testIsPointInsideCylinder1() {
        Cylinder cylinder = new Cylinder(10, 10, 10, 10, 1);
        assertAll(
    ...
    public void testIsPointInsideCylinder2() {
        Cylinder cylinder = new Cylinder(new Point2D(10, 10), 10, 10, 1);
        assertAll(
                () -> assertTrue(cylinder.isInside(10, 10, 10)),
                () -> assertTrue(cylinder.isInside(20, 10, 10)),
                () -> assertTrue(cylinder.isInside(10, 20, 10)),
    ...
    public void testEqualsCylinder() {
        Cylinder cylinder1 = new Cylinder(new Point2D(10, 10), 10, 10, 1);
        Cylinder cylinder2 = new Cylinder(new Point2D(10, 10), 10, 10, 1);
        Cylinder cylinder3 = new Cylinder(new Point2D(10, 10), 20, 10, 1);
        Cylinder cylinder4 = new Cylinder(new Point2D(0, 0), 10, 10, 1);
